        ...
        <div className="p-50 flex flex-col items-center justify-center w-full bg-white text-center">
            <div>
                <h1 className="text-6xl font-bold text-black mb-4">
                    {user ? `Welcome back, ${user.username}!` : "Members Only"}
                </h1>

                <h2 className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">{user?"View your posts or create a new post!":"Create an account to get started or login to access the exclusive clubhouse"}</h2>
                <div className="flex gap-4 justify-center">
                    {user?(
                        <div>
                            <Link className="cursor-pointer bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition" to="/create">Create Post</Link>
                        </div>
                    ):(
                        <div>
